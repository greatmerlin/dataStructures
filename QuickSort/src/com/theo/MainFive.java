...
public class MainFive {
    ...
    public static void main(String[] args) {
        ...
        quickSortPracticeMore(myArray, 0, 7);
        System.out.println(Arrays.toString(myArray));
    }

    public static void quickSortPracticeMore(int[] array, int front, int back){
        if (back - front < 2){
            return;
        }
        int pivotIndex = partition(array, front, back);
        quickSortPracticeMore(array, front, pivotIndex);
        quickSortPracticeMore(array, pivotIndex + 1, back);
    }
